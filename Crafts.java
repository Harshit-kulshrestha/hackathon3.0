...
import java .io.*;
import java.sql.*;
public class Crafts extends HttpServlet
{
...
String s5=req.getParameter("expertise");
...
String query="insert into crafts(name,aadhar,adress,number,expertise)values(?,?,?,?,?)";
PreparedStatement ps=con.prepareStatement(query);
	...
	else
	{
		...
		pw.println("<BR><a href='../crafts.html'>RETRY</a>");
	}
